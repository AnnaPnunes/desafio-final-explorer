...
import { createOrder,getOrder,deleteOrderById, createOrderFinish, getOrderByIdController, getOrderByUserIdController, getOrdersFinish,
    updateOrderStatusController} from "../controllers/OrderController.js";
...
routes.delete('/deleteOrderById/', deleteOrderById);
routes.post('/insertOrderFinish/', createOrderFinish);
routes.get('/getOrderFinishById/:id', getOrderByIdController);
routes.get('/getOrderFinishByUserId/:id', getOrderByUserIdController);
routes.get('/getOrdersFinish', verifyJWT, getOrdersFinish);
routes.put('/updateOrderStatus/:id',verifyJWT,updateOrderStatusController  )
